We're continuing our implementation of Deepgram and Local Model STT by implementing task group number 2:
...
- [ ] 2.0 Complete STT business logic
  - [ ] 2.1 Write 2-8 focused tests for STT Adapters and CLI interactions
  ...
  - [ ] 2.2 Create `DeepgramSTTRuntimeAdapter`
  ...
  - [ ] 2.3 Create `FasterWhisperSTTRuntimeAdapter`
  ...
  - [ ] 2.5 Ensure API/Logic layer tests pass
