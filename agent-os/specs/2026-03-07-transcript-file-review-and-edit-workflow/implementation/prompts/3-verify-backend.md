We're verifying the implementation of Transcript File Review and Edit Workflow by running verification for tasks under the backend-verifier role's purview.
