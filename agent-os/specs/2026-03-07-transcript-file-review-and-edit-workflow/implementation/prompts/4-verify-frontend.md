We're verifying the implementation of Transcript File Review and Edit Workflow by running verification for tasks under the frontend-verifier role's purview.
...
Read @agent-os/specs/2026-03-07-transcript-file-review-and-edit-workflow/spec.md to understand the context for this spec and where these tasks fit into it.
...
5. **(if applicable) view the implementation in a browser:** If your verification purview involves UI implementations, open a browser to view, verify and take screenshots and store screenshot(s) in `agent-os/specs/2026-03-07-transcript-file-review-and-edit-workflow/verification/screenshots`.
...
7. **Verify that implementations have been documented:** Verify that the implementer agent(s) have documented their work in this spec's `agent-os/specs/2026-03-07-transcript-file-review-and-edit-workflow/implementation`. folder.
8. **Document your verification report:** Write your verification report in this spec's `agent-os/specs/2026-03-07-transcript-file-review-and-edit-workflow/verification`. folder.
