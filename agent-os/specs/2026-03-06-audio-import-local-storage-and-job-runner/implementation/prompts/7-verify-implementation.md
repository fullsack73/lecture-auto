We're completing the verification process for Audio Import, Local Storage, and Job Runner by performing the final end-to-end verification and producing the final verification report.

## Understand the context

Read @agent-os/specs/2026-03-06-audio-import-local-storage-and-job-runner/spec.md to understand the full context of this spec.
...
Check `agent-os/specs/2026-03-06-audio-import-local-storage-and-job-runner/tasks.md` and ensure that all tasks and their sub-tasks are marked as completed with `- [x]`.
...
- Check for existence of an implementation report titled using this task's title in `agent-os/spec/2026-03-06-audio-import-local-storage-and-job-runner/implementation/` folder.
...
Check `agent-os/specs/2026-03-06-audio-import-local-storage-and-job-runner/implementations` folder to confirm that each task group from this spec's `tasks.md` has an associated implementation document that is named using the number and title of the task group.

For example, if the 3rd task group is titled "Commenting System", then the implementer of that task group should have already created an implementation document named `agent-os/specs/2026-03-06-audio-import-local-storage-and-job-runner/implementations/3-commenting-system-implementation.md`.
...
Create your final verification report in `agent-os/specs/2026-03-06-audio-import-local-storage-and-job-runner/verifications/final-verification.html`.
