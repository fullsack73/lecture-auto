We're verifying the implementation of Summary Note Generation with Templates by running verification for tasks under the backend-verifier role's purview.

## Task groups under your verification purview

The following task groups have been implemented and need your verification:

- Task Group 1: Note Generation Service & CLI Command (implemented by api-engineer)
- Task Group 2: Test Review & Gap Analysis (implemented by testing-engineer)

## Understand the context

Read @agent-os/specs/2026-03-07-summary-note-generation/spec.md to understand the context for this spec and where these tasks fit into it.
...
5. **(if applicable) view the implementation in a browser:** If your verification purview involves UI implementations, open a browser to view, verify and take screenshots and store screenshot(s) in `agent-os/specs/2026-03-07-summary-note-generation/verification/screenshots`.
...
7. **Verify that implementations have been documented:** Verify that the implementer agent(s) have documented their work in this spec's `agent-os/specs/2026-03-07-summary-note-generation/implementation/` folder.
8. **Document your verification report:** Write your verification report in this spec's `agent-os/specs/2026-03-07-summary-note-generation/verification/` folder.
