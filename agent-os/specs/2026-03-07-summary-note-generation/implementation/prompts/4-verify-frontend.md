We're verifying the implementation of Summary Note Generation with Templates by running verification for tasks under the frontend-verifier role's purview.
