We're verifying the implementation of Remaining Lecture Session Capture Flow Features by running verification for tasks under the backend-verifier role's purview.
