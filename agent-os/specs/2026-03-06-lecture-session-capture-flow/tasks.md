...
- [x] 1.0 Complete metadata persistence layer
  - [x] 1.1 Write 2-8 focused tests for session metadata store
  ...
  - [x] 1.2 Define standardized JSON schema for session metadata
  ...
  - [x] 1.3 Implement metadata read/write utilities
  ...
  - [x] 1.4 Add query helpers for history/detail access
    - List sessions in recent-first order
    - Fetch one session by `session_id`
  - [x] 1.5 Ensure metadata layer tests pass
...
- [x] 2.0 Complete session/capture business logic
  - [x] 2.1 Write 2-8 focused tests for lifecycle logic
    - Limit to 2-8 highly focused tests maximum
  ...
  - [x] 2.4 Implement output contract and error handling
  ...
  - [x] 2.5 Implement naming fallback contract for downstream pipeline
...
- [x] 3.0 Complete terminal interaction design for commands
  - [x] 3.1 Write 2-8 focused tests for CLI UX formatting
    - Limit to 2-8 highly focused tests maximum
...
- [x] 4.0 Review feature tests and fill only critical gaps
  ...
  - [x] 4.2 Identify critical coverage gaps for this spec only
