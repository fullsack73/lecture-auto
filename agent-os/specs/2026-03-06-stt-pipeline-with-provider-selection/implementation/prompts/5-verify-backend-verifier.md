We're verifying the implementation of STT Pipeline with Provider Selection by running verification for tasks under the backend-verifier role's purview.
...
Read @agent-os/specs/2026-03-06-stt-pipeline-with-provider-selection/spec.md to understand the context for this spec and where these tasks fit into it.
...
5. **(if applicable) view the implementation in a browser:** If your verification purview involves UI implementations, open a browser to view, verify and take screenshots and store screenshot(s) in `agent-os/specs/2026-03-06-stt-pipeline-with-provider-selection/verification/screenshots`.
...
7. **Verify that implementations have been documented:** Verify that the implementer agent(s) have documented their work in this spec's `agent-os/specs/2026-03-06-stt-pipeline-with-provider-selection/implementation`. folder.
8. **Document your verification report:** Write your verification report in this spec's `agent-os/specs/2026-03-06-stt-pipeline-with-provider-selection/verification`. folder.
