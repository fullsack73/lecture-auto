We're verifying the implementation of Local Notes Library and Search Commands by running verification for tasks under the frontend-verifier role's purview.
...
Read @agent-os/specs/2026-03-10-local-notes-library-and-search-commands/spec.md to understand the context for this spec and where these tasks fit into it.
...
5. **(if applicable) view the implementation in a browser:** If your verification purview involves UI implementations, open a browser to view, verify and take screenshots and store screenshot(s) in `agent-os/specs/2026-03-10-local-notes-library-and-search-commands/verification/screenshots`.
...
7. **Verify that implementations have been documented:** Verify that the implementer agent(s) have documented their work in this spec's `agent-os/specs/2026-03-10-local-notes-library-and-search-commands/implementation/` folder.
8. **Document your verification report:** Write your verification report in this spec's `agent-os/specs/2026-03-10-local-notes-library-and-search-commands/verification/` folder.
