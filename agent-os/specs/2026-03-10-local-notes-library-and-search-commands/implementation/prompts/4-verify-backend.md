We're verifying the implementation of Local Notes Library and Search Commands by running verification for tasks under the backend-verifier role's purview.
