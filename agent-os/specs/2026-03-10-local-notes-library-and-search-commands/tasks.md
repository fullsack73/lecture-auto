...
- [x] 1.0 Complete library service layer
  - [x] 1.1 Write 2-8 focused tests for `LibraryService`
  ...
  - [x] 1.2 Create `src/lecture_auto/library_service.py` with `LibraryService` class
  ...
  - [x] 1.3 Implement filtering and sorting in `LibraryService`
  ...
  - [x] 1.4 Implement `library_search()` grep-style matching
  ...
  - [x] 1.5 Implement `library_open()` file opener
...
- [x] 2.0 Complete CLI integration
  - [x] 2.1 Write 2-8 focused tests for CLI commands
    - Limit to 2-8 highly focused tests maximum
  ...
  - [x] 2.2 Add `library_app` Typer sub-app to `src/lecture_auto/cli.py`
  ...
  - [x] 2.3 Implement `library list` command in `cli.py`
  ...
  - [x] 2.4 Implement `library search <query>` command in `cli.py`
  ...
  - [x] 2.5 Implement `library open <session-id>` command in `cli.py`
  ...
  - [x] 2.6 Add output formatting branches to `src/lecture_auto/cli_output.py`
...
- [x] 3.0 Add additional focused tests (maximum 10)
  - [x] 3.1 Write up to 10 additional tests covering edge cases
  ...
  - [x] 3.2 Ensure all new tests pass
