...
5. [x] LLM-Based Transcript Refinement
  - **Goal:** Add functionality to clean up transcripts using an LLM to fix typos and formatting.
  - **Priority:** High. This includes improving spacing, wording, and typo correction while preserving lecture meaning. Save before/after transcript outputs as separate local files so users can compare and choose the final input for summarization. `[M]`
